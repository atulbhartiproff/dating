...
const ProfileDetailScreen = () => {
  const { setModalOpen } = useProfileStore();
  ...
  useEffect(() => {
    ...
    return () => {
      setModalOpen(false);
      // Add small delay before allowing gestures
      setTimeout(() => {
  ...
  const handleBack = () => {
    setModalOpen(false);
    // Small delay before navigation to prevent race conditions
    setTimeout(() => {
      router.back();
    }, 100);
  };
  ...
  // ... rest of your styles from the previous implementation
